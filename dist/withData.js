...
exports.default = function (appSyncConfig, options) {
  return function (ComposedComponent) {
    ...
    return _temp = _class = function (_React$Component) {
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 6:
                    ...
                    apollo = (0, _initApollo2.default)(null, appSyncConfig, options);
                    _context.prev = 7;
                    ...
                    _context.next = 11;
                    return (0, _reactApollo.getDataFromTree)(_react2.default.createElement(ComposedComponent, (0, _extends3.default)({ ctx: ctx, url: url }, composedInitialProps)), {
                      router: {
                        asPath: ctx.asPath,
                        pathname: ctx.pathname,
                        query: ctx.query
      ...
      function WithData(props) {
        ...
        _this.apollo = (0, _initApollo2.default)(_this.props.serverState.apollo.data, appSyncConfig, options);
        return _this;
      }
